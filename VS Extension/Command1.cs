...
namespace VS_Extension
{
    ...
    internal sealed class Command1
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("3dcdba07-74fe-467a-8e2d-fb1f0b44954b");
        ...
        private void OutputCode(ref string output, CodeElements elements, string space)
        {
            ...
            {
                var e = enumerator.Current as VCCodeElement;
                output += "\n" + space + e.FullName + ":  " + e.Kind.ToString();
