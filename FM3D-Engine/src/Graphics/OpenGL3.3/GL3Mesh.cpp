...
namespace FM3D {
	...
	GL3Mesh::GL3Mesh(const Skeleton* skeleton, bool supportsInstancing, const ArrayBase<MeshPart>& parts): Mesh(skeleton, supportsInstancing, parts.Size()), m_glBuffers(parts.Size()) {
